...
function createWindow() {
    ...
    mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow({
        ...
        height: 600,
        webPreferences: {
            preload: 'D:\\Nueva carpeta\\Stevie\\task1\\.webpack\\renderer\\main_window\\preload.js',
            sandbox: true,
            contextIsolation: true,
        },
    });
    // and load the index.html of the app.
    mainWindow.loadURL('http://localhost:3000/main_window'); //'./build-view/index.html');
    // Open the DevTools.
...
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on("A", (_, arg1) => {
    if (arg1 === "getDate") {
